...
<div class="container">
	...
	echo $this->Form->input('name', array('type'=>'text','label'=>'ハンドルネーム','div'=>array('class'=>'form-group'),'class'=>'form-control','maxlength'=>'50'));

	echo $this->Form->input('email', array('type'=>'email','label'=>'メールアドレス','div'=>array('class'=>'form-group'),'class'=>'form-control','maxlength'=>'50'));	

	echo $this->Form->input('password', array('div'=>array('class'=>'form-group'),'class'=>'form-control','maxlength'=>'50'));

	//echo $this->Form->label('cebu_history','セブでの滞在期間<br>',array());

	echo '私は'.$this->Form->year('year', 1950 , date('Y'), array('div'=>array('class'=>'form-group'),'class'=>'' )).'年';
